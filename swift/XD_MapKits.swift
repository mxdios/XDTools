...
//  locationtool
//
//  Created by miaoxiaodong on 2020/11/28.
//  Copyright © 2020 markmiao. All rights reserved.
//
...
class XD_MapKits {
    ...
    func transformFromGCJToWGS(p:CLLocationCoordinate2D) -> CLLocationCoordinate2D {
        ...
        while(true) {
            ...
            let rightUp     = transformFromWGSToGCJ(wgsLoc: CLLocationCoordinate2D(latitude: maxLat, longitude: maxLng));
